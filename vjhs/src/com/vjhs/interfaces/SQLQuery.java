...
public interface SQLQuery {
	...
	String GET_STUDENT_BY_ID = "SELECT PHOTO, ADMISSION_NUMBER, DOJ, STUDENT_NAME, DOB, GENDER, NATIONALITY, STATE, RELIGION, CASTE, CASTE_CATEGORY, MOTHER_TOUNGE, FATHER_NAME, MOTHER_NAME, RESIDENCE, FATHER_OCCUPATION, FATHER_RESIDENCE, PHONE_NUMBER, SCHOOLS_PREVIOUS, TC_NUMBER, TC_DATE, CLASS_ADMITTED, MEDIUM, IDENTITY_MARKS FROM STUDENT WHERE ADMISSION_NUMBER = ?";
	...
	String IS_STUDENT_AVAIL ="SELECT COUNT(1) FROM STUDENT WHERE ADMISSION_NUMBER=?";
	...
	String GET_TEACHER_BY_ID = "SELECT EMP_ID,EMP_NAME, FATHER_HUSBAND_NAME, RELIGION, CASTE, GENDER, MARITAL_STATUS, DOB, DOJ, ADDRESS, CITY, STATE, NATIONALITY, PHONE_NUMBER, QUALIFICATION, EXPERIENCE, SUBJECTS, CLASSES_HANDLING, CLASS_TEACHER, DESIGNATION, LOGIN_ID, PASSWORD, CREATION_DATE, CREATED_BY, UPDATED_DATE, UPDATED_BY FROM teacher WHERE EMP_ID=?";
	...
	String IS_TEACHER_AVAILS ="SELECT COUNT(1) FROM TEACHER WHERE EMP_ID=?";
	...
	String GET_FEESTRUCTURE_LIST = "SELECT CLASS, ADMISSION_FEE, APPLICATION_FEE, TUTION_FEE, BOOKS_FEE, EXAM_FEE, OTHER_FEE, TOTAL_FEE, CREATION_DATE, CREATED_BY, UPDATED_DATE, UPDATED_BY FROM FEE_STRUCTURE ORDER BY ATTRIBUTE1";
	...
	String GET_USER = "SELECT USER_ID FROM LOGIN_CREDENTALS WHERE USER_NAME=?";
	String GET_ALLADMINUSERS = "";
	String ADD_LOGINADMIN = "INSERT INTO login_credentals(NAME,EMAIL,USER_NAME, PASSWORD, ROLE, BRANCH) VALUES (?,?,?,?,?,?)";
