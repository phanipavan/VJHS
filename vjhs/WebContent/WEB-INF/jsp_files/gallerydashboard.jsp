...
<!-- Gallery CSS and JS -->
<link rel="stylesheet" href="css_files/vlightbox1.css" type="text/css" />
<link rel="stylesheet" href="css_files/visuallightbox.css" type="text/css" media="screen" />
<script src="js_files/jquery-1.9.0.min.js" type="text/javascript"></script>
<script src="js_files/visuallightbox.js" type="text/javascript"></script>
...
<!--[if lt IE 9]>
    ...
    <!-- AJAX Call for requested galley -->
    
    <script type="text/javascript">
	$(function() {
		$("#anniversary").click(function() {
			$.get("anniversary.html", function(data) {
				$("#view_gallery").html(data);
			});
		});
		$("#building").click(function() {
			$.get("building.html", function(data) {
				$("#view_gallery").html(data);
			});
		});
	});
...
<body>
		...
		<div class="container-fluid">
			...
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav navbar-right">
					<li><a href="aboutschool.user"><img class="img-circle" src="img/AboutSchool.jpg" alt="#"
		...
		<div class="row">
			<div class="col-sm-3 col-md-2 sidebar">
				<ul class="nav nav-sidebar">
					<li class="active">
					<a href="#" id="gallery_main" >Gallery<span class="sr-only">(current)</span></a></li>
					<li ><a href="#" id="anniversary">Anniversary Photos</a></li>
					<li><a href="#" id="building">Building Photos</a></li>
				</ul>
				
			</div>
			<div id="view_gallery" class="gallery"></div>
		</div>
	</div>
	...
	<script src="js_files/vlbdata1.js" type="text/javascript"></script>
</body>
</html>
